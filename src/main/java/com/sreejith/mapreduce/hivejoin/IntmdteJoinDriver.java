...
public class IntmdteJoinDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job1.setJarByClass(IntmdteJoinDriver.class);
		...
		job2.setJarByClass(IntmdteJoinDriver.class);
		...
		job3.setJarByClass(IntmdteJoinDriver.class);
